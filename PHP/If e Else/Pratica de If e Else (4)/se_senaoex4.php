...
<body>
    <div class="box">
        <form method="post" action="if4.php">
            <fieldset>
            <legend><b>Licença de Pilotagem</b></legend>
            <br/><br/>
            <div class="inputBox">
            ...
            <br/>
            <div class="inputBox">
                <input type="text" name="i" id="i" class="inputUser" required>
                <label for="i" class="labelinput">Idade</label>
            </div>
            <br/>
