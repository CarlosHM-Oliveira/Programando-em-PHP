...
<body>
    <div class="box">
        <form method="post" action="if3.php">
            <fieldset>
            <legend><b>Calculo de Quilo</b></legend>
            <br/><br/>
            <div class="inputBox">
            ...
            <br/>
            <div class="inputBox">
                <input type="text" name="q" id="q" class="inputUser" required>
                <label for="q" class="labelinput">Quilo do Peixe</label>
            </div>
            <br/>
